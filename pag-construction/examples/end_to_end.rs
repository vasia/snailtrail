...
fn main() {
    ...
    let config = Config {
        ...
        // },
        message_delay: None,
        verbose: 0, //matches.occurrences_of("v"),
        dump_pag: true, //matches.is_present("dump-pag"),
        write_bc_dot: false, //matches.is_present("bc-dot"),
        write_pag_dot: true, //matches.is_present("pag-dot"),
        write_pag_msgpack: false, //matches.is_present("pag-msgpack"),
        insert_waiting_edges: true, // !matches.is_present("no-insert-waiting"),
