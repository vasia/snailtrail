...
stats input("prepped/prepped_st_8_500.csv") using 3 name "stat8"
...
stats input("prepped/prepped_tc_32_500.csv") using 3 name "stattc"
plot \
  input("prepped/prepped_st_1_500.csv") using 1:($3 / stat1_max) with lines ls 1 title "w1", \
  input("prepped/prepped_st_2_500.csv") using 1:($3 / stat2_max) with lines ls 3 title "w2", \
  input("prepped/prepped_st_4_500.csv") using 1:($3 / stat4_max) with lines ls 5 title "w4", \
  input("prepped/prepped_st_8_500.csv") using 1:($3 / stat8_max) with lines ls 7 title "w8", \
  ...
  input("prepped/prepped_tc_32_500.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri32"
