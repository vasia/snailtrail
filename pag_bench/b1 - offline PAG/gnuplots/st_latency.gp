...
plot \
  ...
  "prepped/prepped_st_32_5.csv" using 1:2 with lines ls 11 smooth bezier title "w32", \
...
plot \
  ...
  "prepped/prepped_st_32_50.csv" using 1:2 with lines ls 11 smooth bezier title "w32", \
...
plot \
  ...
  "prepped/prepped_st_32_200.csv" using 1:2 with lines ls 11 smooth bezier title "w32", \
...
plot \
  "prepped/prepped_st_1_500.csv" using 1:2 with lines ls 1 smooth bezier title "w1", \
  "prepped/prepped_st_2_500.csv" using 1:2 with lines ls 3 smooth bezier title "w2", \
  "prepped/prepped_st_4_500.csv" using 1:2 with lines ls 5 smooth bezier title "w4", \
  "prepped/prepped_st_8_500.csv" using 1:2 with lines ls 7 smooth bezier title "w8", \
  "prepped/prepped_st_16_500.csv" using 1:2 with lines ls 9 smooth bezier title "w16", \
  "prepped/prepped_st_32_500.csv" using 1:2 with lines ls 11 smooth bezier title "w32", \
  "prepped/prepped_tc_32_500.csv" using 1:2 with lines ls 13 smooth bezier title "tri32", \
