...
set output "plots/st_log_throughput.pdf"
...
plot \
  ...
  "< xsv join -n -d ' ' 1 prepped/prepped_st_4_5.csv 1 prepped/prepped_tc_32_5.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 5 smooth bezier title "w4", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_8_5.csv 1 prepped/prepped_tc_32_5.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 7 smooth bezier title "w8", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_16_5.csv 1 prepped/prepped_tc_32_5.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 9 smooth bezier title "w16", \
...
plot \
  ...
  "< xsv join -n -d ' ' 1 prepped/prepped_st_4_50.csv 1 prepped/prepped_tc_32_50.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 5 smooth bezier title "w4", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_8_50.csv 1 prepped/prepped_tc_32_50.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 7 smooth bezier title "w8", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_16_50.csv 1 prepped/prepped_tc_32_50.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 9 smooth bezier title "w16", \
...
plot \
  ...
  "< xsv join -n -d ' ' 1 prepped/prepped_st_4_200.csv 1 prepped/prepped_tc_32_200.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 5 smooth bezier title "w4", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_8_200.csv 1 prepped/prepped_tc_32_200.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 7 smooth bezier title "w8", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_16_200.csv 1 prepped/prepped_tc_32_200.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 9 smooth bezier title "w16", \
...
plot \
  ...
  "< xsv join -n -d ' ' 1 prepped/prepped_st_4_500.csv 1 prepped/prepped_tc_32_500.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 5 smooth bezier title "w4", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_8_500.csv 1 prepped/prepped_tc_32_500.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 7 smooth bezier title "w8", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_16_500.csv 1 prepped/prepped_tc_32_500.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 9 smooth bezier title "w16", \
  "< xsv join -n -d ' ' 1 prepped/prepped_st_32_500.csv 1 prepped/prepped_tc_32_500.csv | xsv fmt -t ' '" using 1:($6 / $2) with lines ls 11 smooth bezier title "w32", \
  "prepped/prepped_tc_32_500.csv" using 1:($3 / $2) with lines ls 13 smooth bezier title "tri32"
