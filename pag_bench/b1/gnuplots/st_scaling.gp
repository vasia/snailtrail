...
plot \
  "prepped/prepped_scaling_tp_1.csv" using 1:2 with lines smooth bezier ls 1 title "w1", \
  "prepped/prepped_scaling_tp_2.csv" using 1:2 with lines smooth bezier ls 3 title "w2", \
  "prepped/prepped_scaling_tp_4.csv" using 1:2 with lines smooth bezier ls 5 title "w4", \
