...
set output "plots/throughput_cdf.pdf"

set tmargin 3
set multiplot layout 3,2 rowsfirst title "Offline log event throughput [500K, 32W]\n{/*0.8 y% of epochs process less than x log events / s}" 
...
stats input("prepped/prepped_maxepoch_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat1"
stats input("prepped/prepped_maxmsg_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat2"
stats input("prepped/prepped_maxop_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat4"
stats input("prepped/prepped_maxprog_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat8"
stats input("prepped/prepped_metrics_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat16"
stats input("prepped/prepped_algo_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat64"
stats input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 3 name "stat32"
...
plot \
  ...
  input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat32_max) with lines ls 15 title "PAG", \
  input("prepped/prepped_maxepoch_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat1_max) with lines ls 1 title "max-epoch"

plot \
  baseline("prepped/prepped_tc_32_200.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri32", \
  input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat32_max) with lines ls 15 title "PAG", \
  input("prepped/prepped_maxmsg_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat2_max) with lines ls 3 title "max-msg"

plot \
  baseline("prepped/prepped_tc_32_200.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri32", \
  input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat32_max) with lines ls 15 title "PAG", \
  input("prepped/prepped_maxop_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat4_max) with lines ls 5 title "max-op"

plot \
  baseline("prepped/prepped_tc_32_200.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri32", \
  input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat32_max) with lines ls 15 title "PAG", \
  input("prepped/prepped_maxprog_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat8_max) with lines ls 7 title "max-prog"

plot \
  baseline("prepped/prepped_tc_32_200.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri32", \
  input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat32_max) with lines ls 15 title "PAG", \
  input("prepped/prepped_metrics_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat16_max) with lines ls 9 title "metrics"

plot \
  baseline("prepped/prepped_tc_32_200.csv") using 1:($3 / stattc_max) with lines ls 13 title "tri32", \
  input("prepped/prepped_pag_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat32_max) with lines ls 15 title "PAG", \
  input("prepped/prepped_algo_32_200.csv", "prepped/prepped_tc_32_200.csv") using 1:($3 / stat64_max) with lines ls 11 title "algo"
...
# set title "Offline latency [500K, 32W]\n{/*0.8 y% of epochs take less than x s}"
